...
class EstateProperty(models.Model):
    ...
    #sequancing
    property_code = fields.Char(string="sequence number", readonly=True, copy=False)
    ...
    def create(self, vals):
        vals['property_code'] = self.env['ir.sequence'].next_by_code('sequence_property_order')
        result = super(EstateProperty, self).create(vals)
        return result